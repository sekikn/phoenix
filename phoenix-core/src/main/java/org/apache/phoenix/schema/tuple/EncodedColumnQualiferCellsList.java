    ...
    public boolean retainAll(Collection<?> collection) {
        ...
        if (collection instanceof EncodedColumnQualiferCellsList) {
            ...
            while (listItr.hasNext()) {
                ...
                //TODO: samarth we would need to pass in the storage scheme here too.
                int qualifier =
                        PInteger.INSTANCE.getCodec().decodeInt(cellInThis.getQualifierArray(),
                            cellInThis.getQualifierOffset(), SortOrder.ASC);
                try {
